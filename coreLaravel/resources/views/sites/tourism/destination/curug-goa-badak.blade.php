...
@section('content')
  ...
  <section class="detail" id="detail">
    <div class="container">
        ...
        <div class="share">
          <div class="content">
            <p>
              ...
              <a href="https://www.facebook.com/sharer.php?u={{ url('tourism/destination/curug-goa-badak') }}">
                <i class="fa fa-facebook-square"></i>
              </a>
              <a href="https://www.google.co.id/maps/place/Curug+Goa+Badak/@-6.7116577,107.6337801,17z/data=!3m1!4b1!4m5!3m4!1s0x2e691f0fd401afb3:0x24afb4fb74f1445!8m2!3d-6.7116577!4d107.6359688" target="_blank">
                <i class="fa fa-map-marker"></i>
              </a>
            </p>
          </div>
      ...
      <div class="bottom">
        <p>
          Curug Goa Badak merupakan kawasan wisata air terjun di Subang yang dikelilingi oleh lahan perkebunan dan pesawahan. Udara di kawasan curug ini cukup sejuk. Air yang mengalir dari atas tebing curug pun sangat jernih, bersih dan terlihat begitu alami. Suasana alamnya begitu menenangkan. Seperti itulah Curug Goa Badak dengan segala keindahan alam yang ada. Rimbunya vegetasi alam, suburnya tanah yang ada hingga kini tumbuh pohon tua dan ilalang liar yang membuat kawasan Curug Goa Badak terlihat begitu alami.
        </p>

        <p>
          Asal muasal penamaan Curug Goa Badak  sebenarnya bukan diambil berdasarkan kepercayaan, geomorfologi atau adat istiadat dari daerah setempat. Melainkan penamaan Curug Goa Badak ini diambil berdasarkan cerita yang beredar dimasyarakat. Dimana pada zaman dahulu kala ada seorang keturunan tionghoa yang sering melakukan perburuan di kawasan wisata ini. Pemburu tersebut sangat sering datang ke lokasi curug, hampir setiap hari pemburu itu datang untuk memburu babi, burung dan hewan liar lainnya. Dan warga selalu melihatnya melintasi perkampungan. Sesekali pemburu itu juga bercengkrama dengan warga setempat. Namun pada suatu waktu, pemburu keturunan tionghoa itu meninggal dunia di sekitar lokasi Curug. Sejak saat itulah wisata indah ini dikenal oleh masyarakat setempat dengan sebutan Curug Goa Badak.
        </p>

        <p>
          Curug Goa Badak menyuguhkan panorama alam yang cukup indah. Uniknya curug ini seperti membentuk sebuah tangga. Dimana air mengalir dari atas tebing berundak-undak seperti tangga. Hal itu disebabkan oleh potongan bebatuan besar.yang memotong laju air yang terjun ke bawah. Dibawahnya juga terdapat kolam air yang menampung jatuhan air terjun tersebut.
          Secara administrative Curug Goa Badak terletak di Desa Curugagung, Kecamatan Segalaherang, Kabupaten Subang, Jawa Barat, Indonesia.
        ...
        <div class="maps">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3962.4756587097168!2d107.63378011450531!3d-6.711657695147759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e691f0fd401afb3%3A0x24afb4fb74f1445!2sCurug+Goa+Badak!5e0!3m2!1sid!2sid!4v1522161282034" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </section>
...
@section('script')
  <script type="text/javascript">
    $('#panorama').css({
      "background" : "url({{ asset('img/view/curug-goa-badak.jpg') }})",
